...
const Slider = React.forwardRef<
  ...
  SliderProps
>(({ className, showTwoThumbs, value, defaultValue, ...props }, ref) => {
  // Determine if we should render two thumbs based on value array length or explicit prop
  const isRange = showTwoThumbs || (Array.isArray(value) && value.length === 2) || (Array.isArray(defaultValue) && defaultValue.length === 2);
